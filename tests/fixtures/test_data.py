...
class TestData:
    ...
    SAMPLE_FEEDBACK: dict[str, Any] = {
        ...
        "images": [],
        "settings": {"image_size_limit": 1024 * 1024, "enable_base64_detail": True},
    }
    ...
    WEBSOCKET_MESSAGES: dict[str, dict[str, Any]] = {
        ...
        "feedback_received": {"type": "feedback_received", "message": "回饋已成功提交"},
        "status_update": {
            "type": "status_update",
            "status_info": {
                "session_id": "test-session-12345",
    ...
    TEST_CONFIG: dict[str, dict[str, Any]] = {
        ...
        "mcp": {"timeout": 60, "retry_count": 3},
        "i18n": {"default_language": "zh-TW", "fallback_language": "en"},
    }
    ...
    def mcp_initialize_response() -> dict[str, Any]:
        ...
        return {
            ...
            "result": {
                ...
                "serverInfo": {"name": "mcp-feedback-enhanced", "version": "2.3.0"},
            },
        }
...
class TestScenarios:
    ...
    I18N_TEST = {
        ...
        "description": "國際化功能測試",
        "steps": ["載入 I18N 管理器", "測試語言切換", "驗證翻譯完整性", "測試回退機制"],
        "expected_result": {
